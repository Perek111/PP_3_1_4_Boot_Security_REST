...
public class InitializationUserDB {
    ...
    public void createUsersWithRoles() {
        ...
        User user1 = new User("Артур", "Урусов", 22,  "urusovartur@gmail.com", "123qweasd", set1 );
        User user2 = new User("Пользователь", "Пользователев", 33,  "user@mail.com", "123qweasd", set2 );
